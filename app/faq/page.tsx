...
const fullFaqs = [
  ...
  {
    q: "How can I get a Laser247 franchise?",
    a: "To obtain a franchise or master ID and start operating as a bookmaker partner under the Laser247 brand, contact our corporate compliance desk through WhatsApp and ask for 'Franchise/Master ID details'. A verification agent will review your request."
  },
  {
  ...
  {
    q: "Is my personal information secure with Laser247?",
  ...
  {
    q: "Can I use Laser247 on my mobile phone?",
  ...
  {
    q: "Is Laser247 genuine or fake?",
    a: "Laser247 is 100% genuine. We are India's oldest sports ID aggregator. Beware of copycat websites and phishing links; only use official routes sent by our verified WhatsApp agents."
  },
  {
    q: "What is the Laser247 contact number?",
        ...
        <Reveal>
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-500 text-sm max-w-xl mx-auto font-light">
              Clear answers to the most common queries about Laser247 account registration, rules, and withdrawals.
            </p>
              ...
              <Reveal key={index} yOffset={25} delay={index * 0.05}>
                <div className="minimal-card rounded border border-zinc-900 overflow-hidden transition-colors">
                  <button
                    ...
                    className="w-full px-6 py-5 flex items-center justify-between text-left text-white hover:text-orange-500 transition-colors"
                  >
                    <span className="font-bold text-sm font-space-grotesk uppercase flex items-center gap-2">
                      <HelpCircle className="w-4.5 h-4.5 text-orange-500 flex-shrink-0" />
                      {faq.q}
                    </span>
                    {isOpen ? <Minus className="w-5 h-5 text-orange-500" /> : <Plus className="w-5 h-5 text-orange-500" />}
                  </button>
                  {isOpen && (
                    <div className="px-6 pb-6 pt-1 text-zinc-500 text-xs font-light leading-relaxed border-t border-zinc-950 bg-zinc-950/20">
                      {faq.a}
                    </div>
                  )}
                </div>
