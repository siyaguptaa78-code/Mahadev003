...
export const metadata: Metadata = {
  ...
  robots: "index, follow",
  verification: {
    google: "BLGZQZjVTQsWhaYvj-p3qKQPd8R0rGDzxzNUYrA_jDI",
  },
  openGraph: {
...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-[#050505] text-zinc-100 font-sans selection:bg-emerald-500/20 selection:text-emerald-300">
        <Navbar />
