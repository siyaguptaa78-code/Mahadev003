...
export const SITE_CONFIG = {
  ...
  keywords:
    "Mahadev Book, Mahadev Book ID, Mahadev Book Login, Mahadev Book Register, Buy Mahadev Book ID, Mahadev Live ID",
  ogImage: "/images/mahadev-book-banner.webp",
  whatsappLink: "https://wa.me/916026703858",
  creator: "Mahadev Book",
  publisher: "Mahadev Book",
  googleVerification: "BLGZQZjVTQsWhaYvj-p3qKQPd8R0rGDzxzNUYrA_jDI",
};
